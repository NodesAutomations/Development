...
Type in a partial filename, files and folders matching your partial filename search will be instantly displayed in the [result list](https://www.voidtools.com/support/everything/using_everything#result_list).
...
Include the path to limit the results to a folder, for example, to find files and folders in the folder **D:*, search for:

```
d:\downloads\
```

Use double quotes to escape spaces , for example, to find files and folders in **C:Files**, search for:
...
Find folders in D:that do not contain an mp3 file:
...
<aside>
💡 **Search File in Specific folder** `FolderName\ *.Ext filename`

</aside>

### Everything Configuration Files
...
ntfs_volume_guids="\\\\?\\Volume{947fe95a-db81-491b-943c-e8df43a9e4d4}","\\\\?\\Volume{629458e4-0000-0000-0000-010000000000}"
ntfs_volume_paths="C:","C:\\ProgramData\\Microsoft\\Windows\\Containers\\BaseImages\\2fd63b74-151b-4257-916b-a471e0f35690\\BaseLayer"
ntfs_volume_roots="",""
